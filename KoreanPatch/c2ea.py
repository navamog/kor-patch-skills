...
def addToInstaller(csvList,installername):
    ...
    with open(installername,"w", encoding='latin-1') as myfile:
    ...
    for csv in csvList:
        ...
        with open(installername,'a', encoding='latin-1') as myfile:
...
def process(inputCSV, inputNMM, filename, rom):
    ...
    with open(inputCSV, 'r', encoding='latin-1') as myfile:
    ...
    with open(filename, 'w', encoding='latin-1') as dumpfile:
        inline = False
